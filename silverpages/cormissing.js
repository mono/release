...
var hoverDiv = null;
function showHover (imgelt)
{
	hoverDiv = document.createElement ("div");
	hoverDiv.className = "hover";

	var pos = getPosition (imgelt);

	hoverDiv.style.left = pos.left + 5;
	hoverDiv.style.top = pos.top + 12 + 5;

	hoverDiv.appendChild (document.createTextNode (imgelt.alt));
