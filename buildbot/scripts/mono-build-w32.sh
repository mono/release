...
install_package glib-2.4.7.zip lib/libglib-2.0-0.dll glib
install_package glib-dev-2.4.7.zip lib/glib-2.0.dll.a glib-dev
install_package libiconv-1.9.1.bin.woe32.zip bin/iconv.dll iconv
install_package gettext-runtime-0.13.1.zip bin/intl.dll intl
