...
[Setup]
AppName=Mono 1.2.5 with GTK# 2.10.2
AppVerName=Mono for Windows 1.2.5
AppPublisher=Mono
...
DefaultDirName={pf}\Mono-1.2.5
DefaultGroupName=Mono 1.2.5 for Windows
AppID={{54838a1f-43f5-463d-b5a4-f31b1b639e75}
...
OutputBaseFilename=mono-1.2.5-gtksharp-2.10.2-win32-0
VersionInfoVersion=1.2.5
VersionInfoDescription=Mono 1.2.5 with Gtk# Installer for Win32
...
Filename: {app}\MonoReleaseNotes.url; Section: InternetShortcut; Components: mono; Key: URL; String: http://go-mono.com/archive/1.2.5/
...
[Icons]
Name: {group}\Mono-1.2.5 Command Prompt; Filename: {cmd}; Parameters: "/k ""{app}\bin\setmonopath.bat"""; Comment: Open Mono 1.2.5 Command Prompt
Name: {group}\Readme; Filename: {app}\ReleaseNotes.txt; Comment: Combined Installer Release Notes
Name: {group}\{cm:ProgramOnTheWeb,Mono-1.2.5 Release Notes}; Filename: {app}\MonoReleaseNotes.url
...
Name: {group}\{cm:UninstallProgram,Mono-1.2.5 Win32}; Filename: {uninstallexe}
...
Root: HKLM; Subkey: Software\Novell\Mono; ValueType: string; ValueName: DefaultCLR; ValueData: 1.2.5; Flags: uninsdeletevalue
Root: HKLM; Subkey: SOFTWARE\Novell\Mono\1.2.5; Flags: uninsdeletekeyifempty
Root: HKLM; Subkey: Software\Novell\Mono\1.2.5; ValueType: string; ValueName: FrameworkAssemblyDirectory; ValueData: {app}\lib; Flags: uninsdeletevalue
Root: HKLM; Subkey: Software\Novell\Mono\1.2.5; ValueType: string; ValueName: MonoConfigDir; ValueData: {app}\etc; Flags: uninsdeletevalue
Root: HKLM; Subkey: Software\Novell\Mono\1.2.5; ValueType: string; ValueName: SdkInstallRoot; ValueData: {app}; Flags: uninsdeletevalue
Root: HKLM; Subkey: Software\Novell\Mono\1.2.5; Components: xsp; ValueType: dword; ValueName: XSPIsInstalled; ValueData: 1; Flags: uninsdeletevalue
Root: HKLM; Subkey: Software\Novell\Mono\1.2.5; Components: gtk\gtkSharp; ValueType: dword; ValueName: GtkSharpIsInstalled; ValueData: 1; Flags: uninsdeletevalue
Root: HKLM; Subkey: Software\Novell\Mono\1.2.5; Components: gtk; ValueType: dword; ValueName: GtkPlusDevIsInstalled; ValueData: 1; Flags: uninsdeletevalue
...
Root: HKLM; Subkey: SOFTWARE\Classes\Folder\shell\XSP WebServer 1.2.5; Components: xsp\xsp_shell; ValueType: string; ValueData: XSP Web Server Here 1.2.5; Flags: uninsdeletekey
Root: HKLM; Subkey: SOFTWARE\Classes\Folder\shell\XSP WebServer 1.2.5\command; Components: xsp\xsp_shell; ValueType: string; ValueData: "{app}\bin\xsp.bat --root ""%1"" --port {code:GetPort} --applications /:."; Flags: uninsdeletekey
Root: HKLM; Subkey: SOFTWARE\Classes\Folder\shell\XSP2 WebServer 1.2.5; Components: xsp\xsp2_shell; ValueType: string; ValueData: XSP 2.0 Web Server Here 1.2.5; Flags: uninsdeletekey
Root: HKLM; Subkey: SOFTWARE\Classes\Folder\shell\XSP2 WebServer 1.2.5\command; Components: xsp\xsp2_shell; ValueType: string; ValueData: "{app}\bin\xsp2.bat --root ""%1"" --port {code:GetPort} --applications /:."; Flags: uninsdeletekey
...
begin
    ...
    bRc := RegQueryStringValue(HKLM, 'SOFTWARE\Novell\Mono\1.2.5', 'SdkInstallRoot',
    strMonoBaseDir
    );
...
// Checks to see if Mono 1.2.5 is Installed
Function IsMonoInstalled() : Boolean;
begin
    Result := RegValueExists(HKLM, 'SOFTWARE\Novell\Mono\1.2.5', 'SdkInstallRoot');
end;
