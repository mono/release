...
[Setup]
AppName=Mono 1.1.11 with GTK# 2.4.0
AppVerName=Mono for Windows 1.1.11
AppPublisher=Mono
...
DefaultDirName={pf}\Mono-1.1.11
DefaultGroupName=Mono 1.1.11 for Windows
AppID={{4997837e-662b-4f38-a520-92b70514f677}
...
OutputBaseFilename=mono-1.1.11-gtksharp-2.4.0-win32-0
VersionInfoVersion=1.1.11
VersionInfoDescription=Mono 1.1.11 with Gtk# Installer for Win32
...
Filename: {app}\MonoReleaseNotes.url; Section: InternetShortcut; Components: mono; Key: URL; String: http://go-mono.com/archive/1.1.11/
...
[Icons]
Name: {group}\Mono-1.1.11 Command Prompt; Filename: {cmd}; Parameters: "/k ""{app}\bin\setmonopath.bat"""; Comment: Open Mono 1.1.11 Command Prompt
Name: {group}\Readme; Filename: {app}\ReleaseNotes.txt; Comment: Combined Installer Release Notes
Name: {group}\{cm:ProgramOnTheWeb,Mono-1.1.11 Release Notes}; Filename: {app}\MonoReleaseNotes.url
...
Name: {group}\{cm:UninstallProgram,Mono-1.1.11 Win32}; Filename: {uninstallexe}
...
Root: HKLM; Subkey: Software\Novell\Mono; ValueType: string; ValueName: DefaultCLR; ValueData: 1.1.11; Flags: uninsdeletevalue
Root: HKLM; Subkey: SOFTWARE\Novell\Mono\1.1.11; Flags: uninsdeletekeyifempty
Root: HKLM; Subkey: Software\Novell\Mono\1.1.11; ValueType: string; ValueName: FrameworkAssemblyDirectory; ValueData: {app}\lib; Flags: uninsdeletevalue
Root: HKLM; Subkey: Software\Novell\Mono\1.1.11; ValueType: string; ValueName: MonoConfigDir; ValueData: {app}\etc; Flags: uninsdeletevalue
Root: HKLM; Subkey: Software\Novell\Mono\1.1.11; ValueType: string; ValueName: SdkInstallRoot; ValueData: {app}; Flags: uninsdeletevalue
Root: HKLM; Subkey: Software\Novell\Mono\1.1.11; Components: xsp; ValueType: dword; ValueName: XSPIsInstalled; ValueData: 1; Flags: uninsdeletevalue
Root: HKLM; Subkey: Software\Novell\Mono\1.1.11; Components: gtk\gtkSharp; ValueType: dword; ValueName: GtkSharpIsInstalled; ValueData: 1; Flags: uninsdeletevalue
Root: HKLM; Subkey: Software\Novell\Mono\1.1.11; Components: gtk; ValueType: dword; ValueName: GtkPlusDevIsInstalled; ValueData: 1; Flags: uninsdeletevalue
...
begin
    ...
    bRc := RegQueryStringValue(HKLM, 'SOFTWARE\Novell\Mono\1.1.11', 'SdkInstallRoot',
    strMonoBaseDir
    );
...
// Checks to see if Mono 1.1.11 is Installed
Function IsMonoInstalled() : Boolean;
begin
    Result := RegValueExists(HKLM, 'SOFTWARE\Novell\Mono\1.1.11', 'SdkInstallRoot');
end;
