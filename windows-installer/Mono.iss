...
[Setup]
AppName=Mono 1.2.3 with GTK# 2.8.3
AppVerName=Mono for Windows 1.2.3
AppPublisher=Mono
...
DefaultDirName={pf}\Mono-1.2.3
DefaultGroupName=Mono 1.2.3 for Windows
AppID={{b178f6f0-792d-4a90-b3f3-12355e69a49e}
...
OutputBaseFilename=mono-1.2.3-gtksharp-2.8.3-win32-0
VersionInfoVersion=1.2.3
VersionInfoDescription=Mono 1.2.3 with Gtk# Installer for Win32
...
Filename: {app}\MonoReleaseNotes.url; Section: InternetShortcut; Components: mono; Key: URL; String: http://go-mono.com/archive/1.2.3/
...
[Icons]
Name: {group}\Mono-1.2.3 Command Prompt; Filename: {cmd}; Parameters: "/k ""{app}\bin\setmonopath.bat"""; Comment: Open Mono 1.2.3 Command Prompt
Name: {group}\Readme; Filename: {app}\ReleaseNotes.txt; Comment: Combined Installer Release Notes
Name: {group}\{cm:ProgramOnTheWeb,Mono-1.2.3 Release Notes}; Filename: {app}\MonoReleaseNotes.url
...
Name: {group}\{cm:UninstallProgram,Mono-1.2.3 Win32}; Filename: {uninstallexe}
...
Root: HKLM; Subkey: Software\Novell\Mono; ValueType: string; ValueName: DefaultCLR; ValueData: 1.2.3; Flags: uninsdeletevalue
Root: HKLM; Subkey: SOFTWARE\Novell\Mono\1.2.3; Flags: uninsdeletekeyifempty
Root: HKLM; Subkey: Software\Novell\Mono\1.2.3; ValueType: string; ValueName: FrameworkAssemblyDirectory; ValueData: {app}\lib; Flags: uninsdeletevalue
Root: HKLM; Subkey: Software\Novell\Mono\1.2.3; ValueType: string; ValueName: MonoConfigDir; ValueData: {app}\etc; Flags: uninsdeletevalue
Root: HKLM; Subkey: Software\Novell\Mono\1.2.3; ValueType: string; ValueName: SdkInstallRoot; ValueData: {app}; Flags: uninsdeletevalue
Root: HKLM; Subkey: Software\Novell\Mono\1.2.3; Components: xsp; ValueType: dword; ValueName: XSPIsInstalled; ValueData: 1; Flags: uninsdeletevalue
Root: HKLM; Subkey: Software\Novell\Mono\1.2.3; Components: gtk\gtkSharp; ValueType: dword; ValueName: GtkSharpIsInstalled; ValueData: 1; Flags: uninsdeletevalue
Root: HKLM; Subkey: Software\Novell\Mono\1.2.3; Components: gtk; ValueType: dword; ValueName: GtkPlusDevIsInstalled; ValueData: 1; Flags: uninsdeletevalue
...
Root: HKLM; Subkey: SOFTWARE\Classes\Folder\shell\XSP WebServer 1.2.3; Components: xsp\xsp_shell; ValueType: string; ValueData: XSP Web Server Here 1.2.3; Flags: uninsdeletekey
Root: HKLM; Subkey: SOFTWARE\Classes\Folder\shell\XSP WebServer 1.2.3\command; Components: xsp\xsp_shell; ValueType: string; ValueData: "{app}\bin\xsp.bat --root ""%1"" --port {code:GetPort} --applications /:."; Flags: uninsdeletekey
Root: HKLM; Subkey: SOFTWARE\Classes\Folder\shell\XSP2 WebServer 1.2.3; Components: xsp\xsp2_shell; ValueType: string; ValueData: XSP 2.0 Web Server Here 1.2.3; Flags: uninsdeletekey
Root: HKLM; Subkey: SOFTWARE\Classes\Folder\shell\XSP2 WebServer 1.2.3\command; Components: xsp\xsp2_shell; ValueType: string; ValueData: "{app}\bin\xsp2.bat --root ""%1"" --port {code:GetPort} --applications /:."; Flags: uninsdeletekey
...
begin
    ...
    bRc := RegQueryStringValue(HKLM, 'SOFTWARE\Novell\Mono\1.2.3', 'SdkInstallRoot',
    strMonoBaseDir
    );
...
// Checks to see if Mono 1.2.3 is Installed
Function IsMonoInstalled() : Boolean;
begin
    Result := RegValueExists(HKLM, 'SOFTWARE\Novell\Mono\1.2.3', 'SdkInstallRoot');
end;
