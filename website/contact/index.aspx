...
<link rel="copyright" href="http://www.gnu.org/copyleft/fdl.html">
    ...
    <link rel="stylesheet" type="text/css" href="http://mono-project.com/skins/MonoWave/screen.css" />
...
<div id="page">
  ...
  <div id="header">
    ...
    <ul>
      ...
      <li id="menu-n-download"><a href="http://www.mono-project.com/Downloads">Download</a></li>
      ...
      <li class="current_page_item" id="menu-n-support"><a href="http://www.mono-project.com/Support">Support</a></li>
      <li id="menu-n-store"><a href="http://www.mono-project.com/Store">Store</a></li>
    </ul>
    <div id="search">
      <form method="get" action="http://www.google.com/search?">
        <div>
          <input value="www.mono-project.com" id="sitesearch" name="sitesearch" type="hidden">
          <input value="www.mono-project.com" id="domains" name="domains" type="hidden">
          <input class="text" name="q" id="q" value="Search Mono" onblur="if (this.value == '') this.value='Search Mono';" onfocus="if (this.value == 'Search Mono') this.value='';" type="text">
    ...
    <div id="content-header">
        <h2><!--BEGIN PAGE TITLE-->Contact Mono at Novell<!--END PAGE TITLE--></h2>
    </div>
    <div id="titlebar">
    </div>
                    ...
                    <ul id="footer-menu">
                        <li><a href="http://www.novell.com/linux"><div id="novell-logo"></div></a>
                            <ul>
                                ...
                                <li><a href="http://www.mono-project.com/Legal">Legal Notices</a></li>
                                <li>          
<a href="http://www.mono-project.com/index.php?title=Special:Userlogin&amp;returnto=Main_Page">Editor Login</a>                           </li>
                            </ul>
                        </li>
                        <li>Mono
                            <ul>
                                <li><a href="http://www.mono-project.com/About">About</a></li>
                                <li><a href="http://www.mono-project.com/Roadmap">Roadmap</a></li>
                                <li><a href="http://www.mono-project.com/Plans">Technologies</a></li>
                                <li><a href="http://www.mono-project.com/Screenshots">Screenshots</a></li>
                                <li><a href="http://www.mono-project.com/FAQ:_General">FAQ</a></li>
                                <li><a href="http://www.mono-project.com/Contact">Contact</a></li>
                            </ul>
                        </li>
                        <li>Download
                            <ul>
                        ...
                        <li>Documentation
                            <ul>
                                <li><a href="http://www.mono-project.com/Start">Getting Started</a></li>
                                <li><a href="http://www.go-mono.com/docs/">API Reference</a></li>
                                <li><a href="http://www.mono-project.com/Articles">Articles</a></li>
                            </ul>
                        </li>
                        <li>Community
                            <ul>
