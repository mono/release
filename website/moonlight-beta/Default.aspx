...
string src_tarball_location = "http://ftp.novell.com/pub/mono/sources/moon/1.99.7";
string svn_location = "http://anonsvn.mono-project.com/source/tags/moon/1.99.7";

void Page_Init(object sender, EventArgs e)
{
        dir = "/var/www/mono-website/go-mono/archive/moonlight-plugins/1.99.7/";
        dir = "downloads/1.99.7";
...
void SetFileName()
{
	xpi = basename + "-1.99.7-" + architecture.SelectedValue + ".xpi";
...
<ul class="machine"> 
<li>
     <a href="/archive/moonlight-plugins/1.99.7/<%=xpi%>" title="<%=xpi%>">
