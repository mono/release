...
string src_tarball_location = "http://ftp.novell.com/pub/mono/sources/moon/1.99.4";
string svn_location = "http://anonsvn.mono-project.com/source/tags/moon/1.99.4";

void Page_Init(object sender, EventArgs e)
{
        dir = "/var/www/mono-website/go-mono/archive/moonlight-plugins/1.99.4/";
        dir = "downloads/1.99.4";
...
void SetFileName()
{
	xpi = basename + "-1.99.4-" + architecture.SelectedValue + ".xpi";
...
<ul class="machine"> 
<li>
     <a href="/archive/moonlight-plugins/1.99.4/<%=xpi%>" title="<%=xpi%>">
