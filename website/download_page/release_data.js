...

	{
		...
		"version" : [
		{
			...
			},
			{
				"name" : i586_x86_64_ia64,
				"desc" : "",
				"downloadText" : yast + "<ul><li><a href=\"http://ftp.novell.com/pub/mono/download-stable/openSUSE_11.1\">http://ftp.novell.com/pub/mono/download-stable/openSUSE_11.1</a></ul>" + yast_help
			}
			]
		},
		{
...

	{
		...
		"version" : [
		{
			...
			"arch" : [
			{
				...
				"downloadText" : "<ul><li><a href='http://ftp.novell.com/pub/mono/archive/2.4/windows-installer/6/mono-2.4-gtksharp-2.12.8-win32-6.exe'>Mono for Windows, Gtk#, and XSP</a></li><li><a href=\"http://ftp.novell.com/pub/mono/gtk-sharp/\">Gtk# for .NET</a></li><li><a href='http://mono-project.com/MoMA'>Mono Migration Analyzer</a></li></ul>"
			}
			]
		}
		]
