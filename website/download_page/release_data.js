...

	{
		...
		"version" : [
		{
			...
			"arch" : [
			{
				...
				"downloadText" : "Includes Mono, Cocoa#, Gtk# installs in /Library/Frameworks:<br/><em>The CSDK packages are for developers embedding mono into their applications.  If you don't know what that means you don't need it.</em><ul><li>Mono 2.4.2.3 Framework<ul><li><a href=\"http://ftp.novell.com/pub/mono/archive/2.4.2.3/macos-10-x86/4/MonoFramework-2.4.2.3_4.macos10.novell.x86.dmg\">Intel</a> <span style=\"font-size: small\">(<a href=\"http://ftp.novell.com/pub/mono/archive/2.4.2.3/macos-10-x86/4/MonoFramework-CSDK-2.4.2.3_4.macos10.novell.x86.dmg\">CSDK</a>)</span></li><li><a href=\"http://ftp.novell.com/pub/mono/archive/2.4.2.3/macos-10-ppc/4/MonoFramework-2.4.2.3_4.macos10.novell.ppc.dmg\">PowerPC</a> <span style=\"font-size: small\">(<a href=\"http://ftp.novell.com/pub/mono/archive/2.4.2.3/macos-10-ppc/4/MonoFramework-CSDK-2.4.2.3_4.macos10.novell.ppc.dmg\">CSDK</a>)</span></li><li><a href=\"http://ftp.novell.com/pub/mono/archive/2.4.2.3/macos-10-universal/4/MonoFramework-2.4.2.3_4.macos10.novell.universal.dmg\">Universal</a> (if you don't know what you need) <span style=\"font-size: small\">(<a href=\"http://ftp.novell.com/pub/mono/archive/2.4.2.3/macos-10-universal/4/MonoFramework-CSDK-2.4.2.3_4.macos10.novell.universal.dmg\">CSDK</a>)</span></li></ul><li><a href=\"http://monodevelop.com/Download/Mac_Preview\">MonoDevelop Preview</a></li></li><li><a href=\"http://go-mono.com/sources/cocoa-sharp/cocoa-sharp-0.9.5.tar.bz2\">Cocoa# 0.9.5 source</a></ul>Gtk# and System.Windows.Forms applications require X11.  Installing on a machine without X11 installed will result in errors during install, and these components will not function correctly."
			}
			]
		}
		]
