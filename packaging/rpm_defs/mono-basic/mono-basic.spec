...
if [ -e %{S:1} ] ; then
	...
	gacutil -package 2.0 -root ${RPM_BUILD_ROOT}/usr/lib -i usr/lib/mono/2.0/Microsoft.VisualBasic.dll
        ...
        wget --tries=1 --timeout=10 http://x64-linux-2.mono.lab.novell.com/builds/RELEASE/$p || true
        wget --tries=1 --timeout=10 http://x64-linux-2.mono.lab.novell.com/builds/HEAD/$p || true
