...
required_rpms = {
	...
	'sles-9': 'XFree86-devel XFree86-libs aaa_base aaa_skel apache2 apache2-devel apache2-prefork autoconf automake bison cpio expat file fontconfig fontconfig-devel freetype2 freetype2-devel gcc gdb glib2 glib2-devel glibc-devel iputils libapr0 libexif libjpeg libpng libpng-devel libtiff libtool libungif m4 make mktemp ncurses-devel patch perl-XML-Parser pkgconfig procps pwdutils rug sles-release sudo tar termcap unzip util-linux vim yast2 yast2-ncurses yast2-packager yast2-ncurses zlib-devel librsvg-devel vte vte-devel pango-devel gtk2-devel libxml2-devel libart_lgpl-devel libgnomecanvas-devel libgnomeui libgnomeui-devel libglade2-devel libxslt-devel libgsf-devel libgnomeprint-devel libgnomeprintui-devel popt-devel esound-devel libbonoboui libgnome gnome-vfs2 libgnomeprint libgnomeprintui kbd netcfg wget',
