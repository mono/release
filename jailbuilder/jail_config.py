...
required_rpms = {
	...
	'sles-9': 'XFree86-devel XFree86-libs aaa_base aaa_skel apache2 apache2-devel apache2-prefork autoconf automake bison cpio expat file fontconfig fontconfig-devel freetype2 freetype2-devel gcc gdb glib2 glib2-devel glibc-devel iputils libapr0 libexif libjpeg libpng libpng-devel libtiff libtool libungif m4 make mktemp ncurses-devel patch perl-XML-Parser pkgconfig procps pwdutils rug sles-release sudo tar termcap unzip util-linux vim yast2 yast2-ncurses yast2-packager yast2-ncurses zlib-devel librsvg-devel vte vte-devel pango-devel gtk2-devel libxml2-devel libart_lgpl-devel libgnomecanvas-devel libgnomeui libgnomeui-devel libglade2-devel libxslt-devel libgsf-devel libgnomeprint-devel libgnomeprintui-devel popt-devel esound-devel libbonoboui libgnome gnome-vfs2 libgnomeprint libgnomeprintui kbd netcfg wget gtksourceview-devel',
	...
	'suse-101': 'aaa_base apache2-devel apache2-prefork autoconf automake esound-devel file freetype2-devel gcc giflib-devel glib2-devel glibc-locale gnome-keyring-devel gnome-panel-devel gstreamer010-devel gstreamer010-plugins-base-devel gtk2-devel gtkhtml2-devel gtksourceview iputils libart_lgpl-devel libglade2-devel libgnomecanvas-devel libgnomeprint libgnomeprint-devel libgnomeprintui libgnomeprintui-devel libgnomeui-devel libgsf-devel libjpeg-devel libpng-devel librsvg librsvg-devel libtiff-devel libtool libxslt-devel make makedev patch perl-XML-LibXML perl-XML-LibXML-Common perl-XML-NamespaceSupport perl-XML-Parser perl-XML-SAX pkgconfig popt-devel procps pwdutils smart sqlite2 sudo sysvinit tar unzip util-linux vim vte-devel wget xorg-x11-devel yast2 yast2-ncurses zip zlib-devel',

	'suse-102': 'aaa_base apache2-devel apache2-prefork autoconf automake bc bison esound-devel file freetype2-devel gcc giflib-devel glib2-devel glibc-locale gnome-keyring-devel gnome-panel-devel gstreamer010-devel gstreamer010-plugins-base-devel gtk2-devel gtkhtml2-devel gtksourceview-devel intltool iputils libart_lgpl-devel libglade2-devel libgnomecanvas-devel libgnomeprint libgnomeprint-devel libgnomeprintui libgnomeprintui-devel libgnomeui-devel libgsf-devel libjpeg-devel libpng-devel librsvg librsvg-devel libtiff-devel libtool libxslt-devel make makedev patch perl-XML-LibXML perl-XML-LibXML-Common perl-XML-NamespaceSupport perl-XML-Parser perl-XML-SAX pkgconfig popt-devel procps pwdutils rsync sqlite2 subversion openssh sudo sysvinit tar update-desktop-files unzip util-linux vim vte-devel wget xorg-x11-devel yast2 yast2-ncurses zip zlib-devel zypper libgnomedb-devel gcc-c++',

	'suse-103': 'aaa_base apache2-devel apache2-prefork autoconf automake bc bison esound-devel file freetype2-devel gcc giflib-devel glib2-devel glibc-locale gnome-keyring-devel gnome-panel-devel gstreamer010-devel gstreamer010-plugins-base-devel gtk2-devel gtkhtml2-devel gtksourceview-devel intltool iputils libart_lgpl-devel libglade2-devel libgnomecanvas-devel libgnomeprint libgnomeprint-devel libgnomeprintui libgnomeprintui-devel libgnomeui-devel libgsf-devel libjpeg-devel libpng-devel librsvg librsvg-devel libtiff-devel libtool libxslt-devel make makedev patch perl-XML-LibXML perl-XML-LibXML-Common perl-XML-NamespaceSupport perl-XML-Parser perl-XML-SAX pkg-config popt-devel procps pwdutils rsync sqlite2 subversion openssh sudo sysvinit tar update-desktop-files unzip util-linux vim vte-devel wget xorg-x11-devel yast2 yast2-ncurses zip zlib-devel zypper libgnomedb-devel libexif-devel mozilla-nspr-devel mozilla-xulrunner181-devel',
