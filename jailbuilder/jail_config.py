...
required_rpms = {
	...
	'suse-100': 'aaa_base apache2-devel apache2-prefork autoconf automake esound-devel file freetype2-devel gcc gconf2-devel giflib-devel glib2-devel gnome-panel-devel gtkhtml2-devel iputils kbd libgda-devel libglade2-devel libgnomecanvas-devel libgnomedb-devel libgnomeprint libgnomeprint-devel libgnomeprintui libgnomeprintui-devel libgnomeui-devel libjpeg-devel libpng-devel librsvg librsvg-devel libtiff-devel make man patch perl-XML-NamespaceSupport perl-XML-Parser perl-XML-SAX pkgconfig popt-devel procps pwdutils python python-elementtree python-xml rpm-python sudo sysvinit tar util-linux vim vte-devel wget xorg-x11-devel yast2 yast2-ncurses yast2-packagemanager yast2-packager zlib-devel',
