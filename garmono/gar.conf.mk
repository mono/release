...
GARMONO_SVNROOT = svn+ssh://user@mono-cvs.ximian.com/source/trunk/


# Versions.
GARMONO_VERSION    = 1.9
MONO_VERSION       = $(GARMONO_VERSION)
LIBGDI_VERSION     = $(MONO_VERSION)
GLUEZILLA_VERSION  = $(MONO_VERSION)
XSP_VERSION        = $(MONO_VERSION)
MODMONO_VERSION    = $(MONO_VERSION)
GTKSHARP_VERSION   = 2.10.4
MAEMOSHARP_VERSION = 0.23
