...
#	[ ! -d $(WORKSRC)/lib/perl5 ] || find $(WORKSRC)/lib/perl5 -type d -name unicore -exec rm -rf '{}' ';'
	[ ! -d $(WORKSRC)/lib/perl5/5.8.7/unicore ] || rm -rf $(WORKSRC)/lib/perl5/5.8.7/unicore
	$(MAKECOOKIE)
...
prune-documentation: prune-extra-help
	rm -rf $(WORKSRC)/doc
	rm -rf $(WORKSRC)/info
...
prune-LessTif:
	rm -rf $(WORKSRC)/LessTif
	rm -rf $(WORKSRC)/$(libdir)/LessTif

prune-extra-help:
	rm -rf $(WORKSRC)/share/doc/README.SECURITY # Thank you mutt
	rm -rf $(WORKSRC)/share/doc/README.SSL # Thank you again, mutt
...
relink-duplicates:
	...
	cd $(WORKSRC)$(bindir) && ln -sf python2.4 python
